            ...
            <View style={Globalstyles.container_2}>
                ...
                <ScrollView >
                    ...
                    <Formik
                        ...
                        {(props) => (
                            <View>
                                ...
                                {/* signup button */}
                                <CustomButton text='Créer compte' onPressButton={props.handleSubmit} />

                                {/* progress bar */}
                                {clicked &&
                                    <ProgressBar text="Veuillez patienter..." />
                                }
                            </View>
                        )}
                    </Formik>
                    ...
                    <View style={Globalstyles.hyperlink_container}>
                        <Text style={Globalstyles.account_text}>Déjà membre? </Text>

                        <TouchableOpacity onPress={() => navigation.navigate('Login', { screen: 'LoginScreen', currentItem: item, currentCategory: category })}>
                            <Text style={Globalstyles.hyperlink_text}>Connectez vous</Text>
                        </TouchableOpacity>
                    </View>
