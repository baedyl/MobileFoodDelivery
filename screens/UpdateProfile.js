...
const updateSchema = yup.object({
    ...
    phone: yup.string()
        ...
        .required()
        .matches(
            /^\d{10}$/, "Phone number is not valid")
});
...
const updateUser = async (values, navigation, user, image, setClicked) => {
    ...
    try {
        if (image == "default" || image == undefined || (image && image.includes("https:"))) {
            await userReference
                .update({
                    name: values.name,
                        ...
                        <Formik
                            ...
                            {(props) => (
                                <View>
                                    ...
                                    {/* Save button */}
                                    <CustomButton text='Sauvegarder' onPressButton={props.handleSubmit} />
