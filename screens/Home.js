...
import { icons, images, SIZES, COLORS, FONTS, categoryData, DATABASE_URL } from '../constants'
...
const Home = ({ navigation }) => {
    ...
    const restaurantsReference = firebase.app().database(DATABASE_URL).ref('/Restaurants/');
    ...
    useEffect(() => {
        let array = [];
        restaurantsReference.on('value', snapshot => {
    ...
    function onSelectCategory(category) {
        ...
        if (category === selectedCategory) {
            ...
            // Select category
            let restaurantList = restaurantDataCopy.filter(a => a.categories.includes(category.id))
